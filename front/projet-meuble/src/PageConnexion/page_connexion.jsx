  ...
  return (
    <>
      <div className="container">
        ...
        {action === "S'incrirer"?<div></div>:<div className="forgot-password">
          Mot de passe oublié ?<span>Clique ici !</span></div>}
        <div className="submit-container">
          <div className={action === "Se connecter" ? "submit gray" : "submit"} onClick={()=>{setAction("Se connecter")}}>Se connecter</div>
          <div className={action === "S'inscrire" ? "submit gray" : "submit"} onClick={()=>{setAction("S'inscrire")}}>S'inscrire</div>
        </div>
      </div>
    </>
  );
